            ...
            <div className="container">
               <div className="row " >
                ...
                <SocialIcon url="https://www.instagram.com/festivity.cg/"/></div></h2> 
                       ...
                       <hr/>
<Slider {...setting}> <div className="col-sm-offset-1" >
<img className="img-rounded img-fluid" src={image} alt="Not found" style={{width:1000, height:350}}  />
          </div>
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid"  src={image1} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid" src={image2} alt="Not found" style={{width:1000, height:350}}/>
          </div >
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid" src={image3} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          <div className="col-sm-offset-1"> 
          <img  className="img-rounded img-fluid" src={image4} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid" src={image5} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid" src={image6} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid" src={image7} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid" src={image8} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid" src={image9} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          <div className="col-sm-offset-1">
          <img  className="img-rounded img-fluid" src={image10} alt="Not found" style={{width:1000, height:350}}/>
          </div>
          </Slider>
<br/>
                ...
                <div className=" col-md-4 " style={{color:'white'}}>
                    ...
                    <div className="well well-thumbnail" width="50" height="40" style={{background:'black'}}>
                        <img id="target" className="img-rounded" src={j.image} alt="not found" width="300" height="200"/>
